...
import com.bandmix.userapi.entity.OrganizationfoKey;
...
//		List<OrganizationCode> findAll();
	...
	// 组织Code取得（Tower别）
	List<OrganizationInfo> findByIdOrganizationCodeAndIdSectorCodeAndIdTowerCode(String organizationCode,
			String towerCode, String sectorCode);
